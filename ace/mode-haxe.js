...
var HaxeHighlightRules = function() {
    ...
    var keywords = (
        "break|case|cast|catch|class|continue|default|else|abstract|enum|extends|for|function|if|implements|using|import|in|inline|interface|new|override|package|private|public|return|static|super|switch|this|throw|trace|try|typedef|untyped|var|do|while|Array|Void|Bool|Int|UInt|Float|Dynamic|String|List|Hash|IntHash|Error|Unknown|Type|Std"
    );
